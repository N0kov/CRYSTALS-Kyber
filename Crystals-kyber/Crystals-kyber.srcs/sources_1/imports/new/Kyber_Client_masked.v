`timescale 1ns / 1ps
// Phase 0 of plan_masked_ntt_option1.md: scaffold for masked Kyber_Client.
// This file is currently a VERBATIM copy of Kyber_Client.v with only the
// module name renamed. Phase 2 will swap NTT_core_Client -> NTT_core_Client_masked
// at the single instantiation point near the bottom of this file.
module Kyber_Client_masked #(
...
// Phase A Stage 0: NTT_core_Client_masked is a byte-identical-port copy of
// NTT_core_Client (no parameters). Subsequent Phase A stages add internal
// masking inside NTT_core_Client_masked.v.
NTT_core_Client_masked ntt(
.clk(clk),
.rst(rst),
.start(start),
.k(k),
